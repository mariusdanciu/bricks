...
impl Instruction {
    ...
    fn parse(reader: &mut InstructionReader<'_>) -> Result<Self, ParseError> {
        ...
        Ok(match opcode {
            ...
            4160u16 => Self::ColorAttachmentReadEXT {
                result_type_id: Id(reader.next_word()?),
                result_id: Id(reader.next_word()?),
            ...
            4161u16 => Self::DepthAttachmentReadEXT {
                result_type_id: Id(reader.next_word()?),
                result_id: Id(reader.next_word()?),
                sample: if !reader.is_empty() {
                    Some(Id(reader.next_word()?))
            ...
            4162u16 => Self::StencilAttachmentReadEXT {
                result_type_id: Id(reader.next_word()?),
                result_id: Id(reader.next_word()?),
                sample: if !reader.is_empty() {
                    Some(Id(reader.next_word()?))
            ...
            4431u16 => Self::GroupNonUniformRotateKHR {
                result_type_id: Id(reader.next_word()?),
                result_id: Id(reader.next_word()?),
                execution: Id(reader.next_word()?),
                value: Id(reader.next_word()?),
            ...
            4456u16 => Self::TypeCooperativeMatrixKHR {
                result_id: Id(reader.next_word()?),
                component_type: Id(reader.next_word()?),
            ...
            4457u16 => Self::CooperativeMatrixLoadKHR {
                result_type_id: Id(reader.next_word()?),
                result_id: Id(reader.next_word()?),
                pointer: Id(reader.next_word()?),
            ...
            4458u16 => Self::CooperativeMatrixStoreKHR {
                pointer: Id(reader.next_word()?),
                object: Id(reader.next_word()?),
                memory_layout: Id(reader.next_word()?),
                stride: if !reader.is_empty() {
            ...
            4459u16 => Self::CooperativeMatrixMulAddKHR {
                result_type_id: Id(reader.next_word()?),
                result_id: Id(reader.next_word()?),
            ...
            4460u16 => Self::CooperativeMatrixLengthKHR {
                result_type_id: Id(reader.next_word()?),
                result_id: Id(reader.next_word()?),
                ty: Id(reader.next_word()?),
            },
            ...
            4480u16 => Self::ImageSampleWeightedQCOM {
                result_type_id: Id(reader.next_word()?),
                result_id: Id(reader.next_word()?),
            ...
            4481u16 => Self::ImageBoxFilterQCOM {
                result_type_id: Id(reader.next_word()?),
                result_id: Id(reader.next_word()?),
                texture: Id(reader.next_word()?),
                coordinates: Id(reader.next_word()?),
            ...
            4482u16 => Self::ImageBlockMatchSSDQCOM {
                result_type_id: Id(reader.next_word()?),
                result_id: Id(reader.next_word()?),
                target: Id(reader.next_word()?),
            ...
            4483u16 => Self::ImageBlockMatchSADQCOM {
                result_type_id: Id(reader.next_word()?),
                result_id: Id(reader.next_word()?),
                target: Id(reader.next_word()?),
                target_coordinates: Id(reader.next_word()?),
            ...
            4500u16 => Self::ImageBlockMatchWindowSSDQCOM {
                result_type_id: Id(reader.next_word()?),
                result_id: Id(reader.next_word()?),
            ...
            4501u16 => Self::ImageBlockMatchWindowSADQCOM {
                result_type_id: Id(reader.next_word()?),
                result_id: Id(reader.next_word()?),
                target_sampled_image: Id(reader.next_word()?),
                target_coordinates: Id(reader.next_word()?),
            ...
            4502u16 => Self::ImageBlockMatchGatherSSDQCOM {
                result_type_id: Id(reader.next_word()?),
                result_id: Id(reader.next_word()?),
                target_sampled_image: Id(reader.next_word()?),
                target_coordinates: Id(reader.next_word()?),
            ...
            4503u16 => Self::ImageBlockMatchGatherSADQCOM {
                result_type_id: Id(reader.next_word()?),
                result_id: Id(reader.next_word()?),
                target_sampled_image: Id(reader.next_word()?),
                target_coordinates: Id(reader.next_word()?),
            ...
            5075u16 => Self::FinalizeNodePayloadsAMDX {
                payload_array: Id(reader.next_word()?),
            },
            5078u16 => Self::FinishWritingNodePayloadAMDX {
                result_type_id: Id(reader.next_word()?),
                result_id: Id(reader.next_word()?),
                payload: Id(reader.next_word()?),
            },
            5090u16 => Self::InitializeNodePayloadsAMDX {
                payload_array: Id(reader.next_word()?),
                visibility: Id(reader.next_word()?),
                payload_count: Id(reader.next_word()?),
                node_index: Id(reader.next_word()?),
            },
            5110u16 => Self::GroupNonUniformQuadAllKHR {
                result_type_id: Id(reader.next_word()?),
                result_id: Id(reader.next_word()?),
                predicate: Id(reader.next_word()?),
            },
            5111u16 => Self::GroupNonUniformQuadAnyKHR {
                result_type_id: Id(reader.next_word()?),
                result_id: Id(reader.next_word()?),
                predicate: Id(reader.next_word()?),
            },
            5249u16 => Self::HitObjectRecordHitMotionNV {
            ...
            5250u16 => Self::HitObjectRecordHitWithIndexMotionNV {
                hit_object: Id(reader.next_word()?),
                acceleration_structure: Id(reader.next_word()?),
                instance_id: Id(reader.next_word()?),
                primitive_id: Id(reader.next_word()?),
            ...
            5251u16 => Self::HitObjectRecordMissMotionNV {
                hit_object: Id(reader.next_word()?),
                sbt_index: Id(reader.next_word()?),
                origin: Id(reader.next_word()?),
                t_min: Id(reader.next_word()?),
            ...
            5252u16 => Self::HitObjectGetWorldToObjectNV {
                result_type_id: Id(reader.next_word()?),
                result_id: Id(reader.next_word()?),
                hit_object: Id(reader.next_word()?),
            },
            5253u16 => Self::HitObjectGetObjectToWorldNV {
                result_type_id: Id(reader.next_word()?),
                result_id: Id(reader.next_word()?),
                hit_object: Id(reader.next_word()?),
            },
            5254u16 => Self::HitObjectGetObjectRayDirectionNV {
                result_type_id: Id(reader.next_word()?),
                result_id: Id(reader.next_word()?),
                hit_object: Id(reader.next_word()?),
            },
            5255u16 => Self::HitObjectGetObjectRayOriginNV {
                result_type_id: Id(reader.next_word()?),
                result_id: Id(reader.next_word()?),
                hit_object: Id(reader.next_word()?),
            },
            5256u16 => Self::HitObjectTraceRayMotionNV {
                hit_object: Id(reader.next_word()?),
                acceleration_structure: Id(reader.next_word()?),
                ray_flags: Id(reader.next_word()?),
            ...
            5257u16 => Self::HitObjectGetShaderRecordBufferHandleNV {
                result_type_id: Id(reader.next_word()?),
                result_id: Id(reader.next_word()?),
                hit_object: Id(reader.next_word()?),
            },
            5258u16 => Self::HitObjectGetShaderBindingTableRecordIndexNV {
                result_type_id: Id(reader.next_word()?),
                result_id: Id(reader.next_word()?),
                hit_object: Id(reader.next_word()?),
            },
            5259u16 => Self::HitObjectRecordEmptyNV {
                hit_object: Id(reader.next_word()?),
            },
            5260u16 => Self::HitObjectTraceRayNV {
                hit_object: Id(reader.next_word()?),
                acceleration_structure: Id(reader.next_word()?),
                ray_flags: Id(reader.next_word()?),
                cullmask: Id(reader.next_word()?),
            ...
            5261u16 => Self::HitObjectRecordHitNV {
                hit_object: Id(reader.next_word()?),
                acceleration_structure: Id(reader.next_word()?),
                instance_id: Id(reader.next_word()?),
                primitive_id: Id(reader.next_word()?),
            ...
            5262u16 => Self::HitObjectRecordHitWithIndexNV {
                hit_object: Id(reader.next_word()?),
                acceleration_structure: Id(reader.next_word()?),
                instance_id: Id(reader.next_word()?),
                primitive_id: Id(reader.next_word()?),
            ...
            5263u16 => Self::HitObjectRecordMissNV {
                hit_object: Id(reader.next_word()?),
                sbt_index: Id(reader.next_word()?),
                origin: Id(reader.next_word()?),
                t_min: Id(reader.next_word()?),
            ...
            5264u16 => Self::HitObjectExecuteShaderNV {
                hit_object: Id(reader.next_word()?),
                payload: Id(reader.next_word()?),
            },
            5265u16 => Self::HitObjectGetCurrentTimeNV {
                result_type_id: Id(reader.next_word()?),
                result_id: Id(reader.next_word()?),
                hit_object: Id(reader.next_word()?),
            },
            5266u16 => Self::HitObjectGetAttributesNV {
                hit_object: Id(reader.next_word()?),
                hit_object_attribute: Id(reader.next_word()?),
            },
            5267u16 => Self::HitObjectGetHitKindNV {
                result_type_id: Id(reader.next_word()?),
                result_id: Id(reader.next_word()?),
                hit_object: Id(reader.next_word()?),
            },
            5268u16 => Self::HitObjectGetPrimitiveIndexNV {
                result_type_id: Id(reader.next_word()?),
                result_id: Id(reader.next_word()?),
                hit_object: Id(reader.next_word()?),
            },
            5269u16 => Self::HitObjectGetGeometryIndexNV {
                result_type_id: Id(reader.next_word()?),
                result_id: Id(reader.next_word()?),
                hit_object: Id(reader.next_word()?),
            },
            5270u16 => Self::HitObjectGetInstanceIdNV {
                result_type_id: Id(reader.next_word()?),
                result_id: Id(reader.next_word()?),
                hit_object: Id(reader.next_word()?),
            },
            5271u16 => Self::HitObjectGetInstanceCustomIndexNV {
                result_type_id: Id(reader.next_word()?),
                result_id: Id(reader.next_word()?),
                hit_object: Id(reader.next_word()?),
            },
            5272u16 => Self::HitObjectGetWorldRayDirectionNV {
                result_type_id: Id(reader.next_word()?),
                result_id: Id(reader.next_word()?),
                hit_object: Id(reader.next_word()?),
            },
            5273u16 => Self::HitObjectGetWorldRayOriginNV {
                result_type_id: Id(reader.next_word()?),
                result_id: Id(reader.next_word()?),
                hit_object: Id(reader.next_word()?),
            },
            5274u16 => Self::HitObjectGetRayTMaxNV {
                result_type_id: Id(reader.next_word()?),
                result_id: Id(reader.next_word()?),
                hit_object: Id(reader.next_word()?),
            },
            5275u16 => Self::HitObjectGetRayTMinNV {
                result_type_id: Id(reader.next_word()?),
                result_id: Id(reader.next_word()?),
                hit_object: Id(reader.next_word()?),
            },
            5276u16 => Self::HitObjectIsEmptyNV {
                result_type_id: Id(reader.next_word()?),
                result_id: Id(reader.next_word()?),
                hit_object: Id(reader.next_word()?),
            },
            5277u16 => Self::HitObjectIsHitNV {
                result_type_id: Id(reader.next_word()?),
                result_id: Id(reader.next_word()?),
                hit_object: Id(reader.next_word()?),
            },
            5278u16 => Self::HitObjectIsMissNV {
                result_type_id: Id(reader.next_word()?),
                result_id: Id(reader.next_word()?),
                hit_object: Id(reader.next_word()?),
            },
            5279u16 => Self::ReorderThreadWithHitObjectNV {
                hit_object: Id(reader.next_word()?),
            ...
            5280u16 => Self::ReorderThreadWithHintNV {
                hint: Id(reader.next_word()?),
                bits: Id(reader.next_word()?),
            },
            5281u16 => Self::TypeHitObjectNV {
                result_id: Id(reader.next_word()?),
            },
            ...
            5295u16 => Self::SetMeshOutputsEXT {
            ...
            5300u16 => Self::FetchMicroTriangleVertexPositionNV {
                result_type_id: Id(reader.next_word()?),
                result_id: Id(reader.next_word()?),
                accel: Id(reader.next_word()?),
                instance_id: Id(reader.next_word()?),
            ...
            5301u16 => Self::FetchMicroTriangleVertexBarycentricNV {
                result_type_id: Id(reader.next_word()?),
                result_id: Id(reader.next_word()?),
                accel: Id(reader.next_word()?),
                instance_id: Id(reader.next_word()?),
            ...
            5340u16 => Self::RayQueryGetIntersectionTriangleVertexPositionsKHR {
                result_type_id: Id(reader.next_word()?),
                result_id: Id(reader.next_word()?),
                ray_query: Id(reader.next_word()?),
                intersection: Id(reader.next_word()?),
            ...
            5911u16 => Self::AliasDomainDeclINTEL {
                result_id: Id(reader.next_word()?),
            ...
            5912u16 => Self::AliasScopeDeclINTEL {
                result_id: Id(reader.next_word()?),
            ...
            5913u16 => Self::AliasScopeListDeclINTEL {
                result_id: Id(reader.next_word()?),
            ...
            6096u16 => Self::CompositeConstructContinuedINTEL {
                result_type_id: Id(reader.next_word()?),
                result_id: Id(reader.next_word()?),
                constituents: {
                    let mut vec = Vec::new();
            ...
            6116u16 => Self::ConvertFToBF16INTEL {
                result_type_id: Id(reader.next_word()?),
                result_id: Id(reader.next_word()?),
                float_value: Id(reader.next_word()?),
            },
            6117u16 => Self::ConvertBF16ToFINTEL {
                result_type_id: Id(reader.next_word()?),
                result_id: Id(reader.next_word()?),
                b_float16_value: Id(reader.next_word()?),
            },
            6142u16 => Self::ControlBarrierArriveINTEL {
                execution: Id(reader.next_word()?),
                memory: Id(reader.next_word()?),
                semantics: Id(reader.next_word()?),
            },
            6143u16 => Self::ControlBarrierWaitINTEL {
                execution: Id(reader.next_word()?),
                memory: Id(reader.next_word()?),
                semantics: Id(reader.next_word()?),
            },
            6401u16 => Self::GroupIMulKHR {
                result_type_id: Id(reader.next_word()?),
                result_id: Id(reader.next_word()?),
                execution: Id(reader.next_word()?),
                operation: GroupOperation::parse(reader)?,
            ...
            6403u16 => Self::GroupBitwiseAndKHR {
                result_type_id: Id(reader.next_word()?),
                result_id: Id(reader.next_word()?),
                execution: Id(reader.next_word()?),
                operation: GroupOperation::parse(reader)?,
            ...
            6404u16 => Self::GroupBitwiseOrKHR {
                result_type_id: Id(reader.next_word()?),
                result_id: Id(reader.next_word()?),
                execution: Id(reader.next_word()?),
                operation: GroupOperation::parse(reader)?,
            ...
            6405u16 => Self::GroupBitwiseXorKHR {
                result_type_id: Id(reader.next_word()?),
                result_id: Id(reader.next_word()?),
                execution: Id(reader.next_word()?),
                operation: GroupOperation::parse(reader)?,
            ...
            6406u16 => Self::GroupLogicalAndKHR {
                result_type_id: Id(reader.next_word()?),
                result_id: Id(reader.next_word()?),
                execution: Id(reader.next_word()?),
                operation: GroupOperation::parse(reader)?,
            ...
            6407u16 => Self::GroupLogicalOrKHR {
                result_type_id: Id(reader.next_word()?),
                result_id: Id(reader.next_word()?),
                execution: Id(reader.next_word()?),
                operation: GroupOperation::parse(reader)?,
            ...
            6408u16 => Self::GroupLogicalXorKHR {
                result_type_id: Id(reader.next_word()?),
                result_id: Id(reader.next_word()?),
                execution: Id(reader.next_word()?),
                operation: GroupOperation::parse(reader)?,
            ...
            6428u16 => Self::MaskedGatherINTEL {
                result_type_id: Id(reader.next_word()?),
                result_id: Id(reader.next_word()?),
            ...
            6429u16 => Self::MaskedScatterINTEL {
    ...
    #[doc = r" Returns the `Id` of the type of `result_id`, if any."]
    pub fn result_type_id(&self) -> Option<Id> {
        match self {
            ...
            | Self::RayQueryGetIntersectionTriangleVertexPositionsKHR { result_type_id, .. }
            ...
            | Self::SubgroupAvcMceGetDefaultInterDirectionPenaltyINTEL { result_type_id, .. }
            | Self::SubgroupAvcMceSetInterDirectionPenaltyINTEL { result_type_id, .. }
            | Self::SubgroupAvcMceGetDefaultIntraLumaShapePenaltyINTEL { result_type_id, .. }
            | Self::SubgroupAvcMceGetDefaultInterMotionVectorCostTableINTEL {
                result_type_id,
                ..
            }
            | Self::SubgroupAvcMceGetDefaultHighPenaltyCostTableINTEL { result_type_id, .. }
            | Self::SubgroupAvcMceGetDefaultMediumPenaltyCostTableINTEL {
                result_type_id, ..
            }
            | Self::SubgroupAvcMceGetDefaultLowPenaltyCostTableINTEL { result_type_id, .. }
            | Self::SubgroupAvcMceSetMotionVectorCostFunctionINTEL { result_type_id, .. }
            | Self::SubgroupAvcMceGetDefaultIntraLumaModePenaltyINTEL { result_type_id, .. }
            | Self::SubgroupAvcMceGetDefaultNonDcLumaIntraPenaltyINTEL { result_type_id, .. }
            ...
            | Self::SubgroupAvcImeStripSingleReferenceStreamoutINTEL { result_type_id, .. }
            ...
            | Self::SubgroupAvcImeGetTruncatedSearchIndicationINTEL { result_type_id, .. }
            | Self::SubgroupAvcImeGetUnidirectionalEarlySearchTerminationINTEL {
                result_type_id,
                ..
            }
            ...
            | Self::SubgroupAvcSicSetIntraLumaModeCostFunctionINTEL { result_type_id, .. }
            | Self::SubgroupAvcSicSetIntraChromaModeCostFunctionINTEL { result_type_id, .. }
            | Self::SubgroupAvcSicSetBilinearFilterEnableINTEL { result_type_id, .. }
            | Self::SubgroupAvcSicSetSkcForwardTransformEnableINTEL { result_type_id, .. }
            ...
            | Self::SubgroupAvcSicGetPackedSkcLumaCountThresholdINTEL { result_type_id, .. }
            | Self::SubgroupAvcSicGetPackedSkcLumaSumThresholdINTEL { result_type_id, .. }
    ...
    #[doc = r" Returns the `Id` of the pointer in an atomic operation, if any."]
    ...
    #[doc = r" Returns whether the instruction is a cooperative matrix instruction."]
    ...
    #[doc = r" Returns whether the instruction is an NV cooperative matrix instruction."]
    ...
    #[doc = r" Returns whether the instruction is a group operation instruction."]
    ...
    #[doc = r" Returns whether the instruction is a quad group operation instruction."]
    ...
    #[doc = r" Returns whether the instruction is an `ImageFetch*` instruction."]
    pub fn is_image_fetch(&self) -> bool {
        matches!(self, Self::ImageFetch { .. })
    }
    #[doc = r" Returns whether the instruction is an `Image*Gather` instruction."]
    ...
    #[doc = r" Returns whether the instruction is an `ImageSample*` instruction."]
    ...
    #[doc = r" Returns the `Id` of the execution scope ID operand, if any."]
    ...
    #[doc = r" Returns the `Id` of the memory scope ID operand, if any."]
    ...
    #[doc = r" Returns the image operands, if any."]
...
impl RawAccessChainOperands {
    #[allow(dead_code)]
    fn parse(reader: &mut InstructionReader<'_>) -> Result<RawAccessChainOperands, ParseError> {
        let value = reader.next_word()?;
        Ok(Self {
...
impl CooperativeMatrixOperands {
    #[allow(dead_code)]
    fn parse(reader: &mut InstructionReader<'_>) -> Result<CooperativeMatrixOperands, ParseError> {
        let value = reader.next_word()?;
        Ok(Self {
...
pub enum ExecutionMode {
    ...
    StreamingInterfaceINTEL {
        stall_free_return: u32,
    } = 6154u32,
    RegisterMapInterfaceINTEL {
        wait_for_done_write: u32,
    } = 6160u32,
...
impl ExecutionMode {
    ...
    fn parse(reader: &mut InstructionReader<'_>) -> Result<ExecutionMode, ParseError> {
        Ok(match reader.next_word()? {
            ...
            5071u32 => Self::MaxNodeRecursionAMDX {
            ...
            5270u32 => Self::OutputPrimitivesEXT {
            ...
            6154u32 => Self::StreamingInterfaceINTEL {
                stall_free_return: reader.next_word()?,
            },
            6160u32 => Self::RegisterMapInterfaceINTEL {
                wait_for_done_write: reader.next_word()?,
            },
            6417u32 => Self::NamedBarrierCountINTEL {
                barrier_count: reader.next_word()?,
            },
            6461u32 => Self::MaximumRegistersINTEL {
                number_of_registers: reader.next_word()?,
            },
            6462u32 => Self::MaximumRegistersIdINTEL {
                number_of_registers: Id(reader.next_word()?),
            },
            6463u32 => Self::NamedMaximumRegistersINTEL {
                named_maximum_number_of_registers: NamedMaximumNumberOfRegisters::parse(reader)?,
            },
            value => {
...
impl HostAccessQualifier {
    #[allow(dead_code)]
    fn parse(reader: &mut InstructionReader<'_>) -> Result<HostAccessQualifier, ParseError> {
        Ok(match reader.next_word()? {
            0u32 => Self::NoneINTEL,
            1u32 => Self::ReadINTEL,
            ...
            value => {
                return Err(
                    reader.map_err(ParseErrors::UnknownEnumerant("HostAccessQualifier", value))
                )
            }
        })
    }
...
impl Decoration {
    ...
    fn parse(reader: &mut InstructionReader<'_>) -> Result<Decoration, ParseError> {
        Ok(match reader.next_word()? {
            ...
            5019u32 => Self::NodeSharesPayloadLimitsWithAMDX {
                payload_array: Id(reader.next_word()?),
            },
            5020u32 => Self::NodeMaxPayloadsAMDX {
                max_number_of_payloads: Id(reader.next_word()?),
            },
            5078u32 => Self::TrackFinishWritingAMDX,
            5091u32 => Self::PayloadNodeNameAMDX {
            ...
            5883u32 => Self::StridesizeINTEL {
                stride_size: reader.next_word()?,
            },
            5884u32 => Self::WordsizeINTEL {
            ...
            5909u32 => Self::MathOpDSPModeINTEL {
                mode: reader.next_word()?,
                propagate: reader.next_word()?,
            },
            5914u32 => Self::AliasScopeINTEL {
                aliasing_scopes_list: Id(reader.next_word()?),
            },
            5915u32 => Self::NoAliasINTEL {
                aliasing_scopes_list: Id(reader.next_word()?),
            },
            5917u32 => Self::InitiationIntervalINTEL {
                cycles: reader.next_word()?,
            },
            5918u32 => Self::MaxConcurrencyINTEL {
                invocations: reader.next_word()?,
            },
            5919u32 => Self::PipelineEnableINTEL {
            ...
            6170u32 => Self::FPMaxErrorDecorationINTEL {
                max_error: f32::from_bits(reader.next_word()?),
            },
            6172u32 => Self::LatencyControlLabelINTEL {
                latency_label: reader.next_word()?,
            },
            6173u32 => Self::LatencyControlConstraintINTEL {
            ...
            6177u32 => Self::MMHostInterfaceAddressWidthINTEL {
                address_width: reader.next_word()?,
            },
            6178u32 => Self::MMHostInterfaceDataWidthINTEL {
                data_width: reader.next_word()?,
            },
            6179u32 => Self::MMHostInterfaceLatencyINTEL {
                latency: reader.next_word()?,
            },
            6180u32 => Self::MMHostInterfaceReadWriteModeINTEL {
                read_write_mode: AccessQualifier::parse(reader)?,
            },
            6181u32 => Self::MMHostInterfaceMaxBurstINTEL {
                max_burst_count: reader.next_word()?,
            },
            6182u32 => Self::MMHostInterfaceWaitRequestINTEL {
            ...
            6190u32 => Self::InitModeINTEL {
                trigger: InitializationModeQualifier::parse(reader)?,
            },
            6191u32 => Self::ImplementInRegisterMapINTEL {
...
impl CooperativeMatrixLayout {
    #[allow(dead_code)]
    fn parse(reader: &mut InstructionReader<'_>) -> Result<CooperativeMatrixLayout, ParseError> {
        Ok(match reader.next_word()? {
...
impl CooperativeMatrixUse {
    #[allow(dead_code)]
    fn parse(reader: &mut InstructionReader<'_>) -> Result<CooperativeMatrixUse, ParseError> {
        Ok(match reader.next_word()? {
            ...
            value => {
                return Err(
                    reader.map_err(ParseErrors::UnknownEnumerant("CooperativeMatrixUse", value))
                )
            }
        })
    }
...
impl LoadCacheControl {
    #[allow(dead_code)]
    fn parse(reader: &mut InstructionReader<'_>) -> Result<LoadCacheControl, ParseError> {
        Ok(match reader.next_word()? {
            ...
            value => {
                return Err(reader.map_err(ParseErrors::UnknownEnumerant("LoadCacheControl", value)))
            }
        })
    }
}
...
impl StoreCacheControl {
    #[allow(dead_code)]
    fn parse(reader: &mut InstructionReader<'_>) -> Result<StoreCacheControl, ParseError> {
        Ok(match reader.next_word()? {
            0u32 => Self::UncachedINTEL,
            ...
            value => {
                return Err(
                    reader.map_err(ParseErrors::UnknownEnumerant("StoreCacheControl", value))
                )
            }
        })
    }
