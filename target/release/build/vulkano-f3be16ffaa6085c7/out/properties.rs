...
pub struct DeviceProperties {
    ...
    #[doc = "- [Vulkan documentation](https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkPhysicalDeviceMaintenance6PropertiesKHR.html#limits-blockTexelViewCompatibleMultipleLayers)"]
    ...
    #[doc = "- [Vulkan documentation](https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkPhysicalDeviceCudaKernelLaunchPropertiesNV.html#limits-computeCapabilityMajor)"]
    pub compute_capability_major: Option<u32>,
    #[doc = "- [Vulkan documentation](https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkPhysicalDeviceCudaKernelLaunchPropertiesNV.html#limits-computeCapabilityMinor)"]
    ...
    #[doc = "- [Vulkan documentation](https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkPhysicalDeviceCooperativeMatrixPropertiesKHR.html#limits-cooperativeMatrixSupportedStages)"]
    ...
    #[doc = "- [Vulkan documentation](https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkPhysicalDeviceMaintenance5PropertiesKHR.html#limits-depthStencilSwizzleOneSupport)"]
    ...
    #[doc = "- [Vulkan documentation](https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkPhysicalDeviceMaintenance5PropertiesKHR.html#limits-earlyFragmentMultisampleCoverageAfterSampleCounting)"]
    pub early_fragment_multisample_coverage_after_sample_counting: Option<bool>,
    #[doc = "- [Vulkan documentation](https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkPhysicalDeviceMaintenance5PropertiesKHR.html#limits-earlyFragmentSampleMaskTestBeforeSampleCounting)"]
    pub early_fragment_sample_mask_test_before_sample_counting: Option<bool>,
    #[doc = "- [Vulkan documentation](https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkPhysicalDeviceShaderEnqueuePropertiesAMDX.html#limits-executionGraphDispatchAddressAlignment)"]
    pub execution_graph_dispatch_address_alignment: Option<u32>,
    #[doc = "- [Vulkan documentation](https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkPhysicalDeviceExtendedSparseAddressSpacePropertiesNV.html#limits-extendedSparseAddressSpaceSize)"]
    pub extended_sparse_address_space_size: Option<DeviceSize>,
    #[doc = "- [Vulkan documentation](https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkPhysicalDeviceExtendedSparseAddressSpacePropertiesNV.html#limits-extendedSparseBufferUsageFlags)"]
    pub extended_sparse_buffer_usage_flags: Option<BufferUsage>,
    #[doc = "- [Vulkan documentation](https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkPhysicalDeviceExtendedSparseAddressSpacePropertiesNV.html#limits-extendedSparseImageUsageFlags)"]
    pub extended_sparse_image_usage_flags: Option<ImageUsage>,
    #[doc = "- [Vulkan documentation](https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkPhysicalDeviceExternalFormatResolvePropertiesANDROID.html#limits-externalFormatResolveChromaOffsetX)"]
    pub external_format_resolve_chroma_offset_x: Option<ChromaLocation>,
    #[doc = "- [Vulkan documentation](https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkPhysicalDeviceExternalFormatResolvePropertiesANDROID.html#limits-externalFormatResolveChromaOffsetY)"]
    ...
    #[doc = "- [Vulkan documentation](https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkPhysicalDeviceShaderCorePropertiesARM.html#limits-fmaRate)"]
    ...
    #[doc = "- [Vulkan documentation](https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkPhysicalDeviceMaintenance6PropertiesKHR.html#limits-fragmentShadingRateClampCombinerInputs)"]
    ...
    #[doc = "- [Vulkan documentation](https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkPhysicalDeviceHostImageCopyPropertiesEXT.html#limits-identicalMemoryTypeRequirements)"]
    ...
    #[doc = "- [Vulkan documentation](https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkPhysicalDeviceClusterCullingShaderPropertiesHUAWEI.html#limits-indirectBufferOffsetAlignment)"]
    ...
    #[doc = "- [Vulkan documentation](https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkPhysicalDeviceLineRasterizationPropertiesKHR.html#limits-lineSubPixelPrecisionBits)"]
    ...
    #[doc = "- [Vulkan documentation](https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkPhysicalDeviceImageProcessing2PropertiesQCOM.html#limits-maxBlockMatchWindow)"]
    ...
    #[doc = "- [Vulkan documentation](https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkPhysicalDeviceMaintenance6PropertiesKHR.html#limits-maxCombinedImageSamplerDescriptorCount)"]
    pub max_combined_image_sampler_descriptor_count: Option<u32>,
    #[doc = "- [Vulkan documentation](https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkPhysicalDeviceNestedCommandBufferPropertiesEXT.html#limits-maxCommandBufferNestingLevel)"]
    ...
    #[doc = "- [Vulkan documentation](https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkPhysicalDeviceDisplacementMicromapPropertiesNV.html#limits-maxDisplacementMicromapSubdivisionLevel)"]
    ...
    #[doc = "- [Vulkan documentation](https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkPhysicalDeviceShaderEnqueuePropertiesAMDX.html#limits-maxExecutionGraphDepth)"]
    pub max_execution_graph_depth: Option<u32>,
    #[doc = "- [Vulkan documentation](https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkPhysicalDeviceShaderEnqueuePropertiesAMDX.html#limits-maxExecutionGraphShaderOutputNodes)"]
    pub max_execution_graph_shader_output_nodes: Option<u32>,
    #[doc = "- [Vulkan documentation](https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkPhysicalDeviceShaderEnqueuePropertiesAMDX.html#limits-maxExecutionGraphShaderPayloadCount)"]
    pub max_execution_graph_shader_payload_count: Option<u32>,
    #[doc = "- [Vulkan documentation](https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkPhysicalDeviceShaderEnqueuePropertiesAMDX.html#limits-maxExecutionGraphShaderPayloadSize)"]
    ...
    #[doc = "- [Vulkan documentation](https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkPhysicalDeviceClusterCullingShaderPropertiesHUAWEI.html#limits-maxOutputClusterCount)"]
    ...
    #[doc = "- [Vulkan documentation](https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkPhysicalDeviceRenderPassStripedPropertiesARM.html#limits-maxRenderPassStripes)"]
    ...
    #[doc = "- [Vulkan documentation](https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkPhysicalDeviceVertexAttributeDivisorPropertiesKHR.html#limits-maxVertexAttribDivisor)"]
    ...
    #[doc = "- [Vulkan documentation](https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkPhysicalDeviceClusterCullingShaderPropertiesHUAWEI.html#limits-maxWorkGroupCount)"]
    pub max_work_group_count: Option<[u32; 3]>,
    #[doc = "- [Vulkan documentation](https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkPhysicalDeviceClusterCullingShaderPropertiesHUAWEI.html#limits-maxWorkGroupSize)"]
    pub max_work_group_size: Option<[u32; 3]>,
    ...
    #[doc = "- [Vulkan documentation](https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkPhysicalDeviceMapMemoryPlacedPropertiesEXT.html#limits-minPlacedMemoryMapAlignment)"]
    ...
    #[doc = "- [Vulkan documentation](https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkPhysicalDeviceMaintenance5PropertiesKHR.html#limits-nonStrictSinglePixelWideLinesUseParallelogram)"]
    pub non_strict_single_pixel_wide_lines_use_parallelogram: Option<bool>,
    #[doc = "- [Vulkan documentation](https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkPhysicalDeviceMaintenance5PropertiesKHR.html#limits-nonStrictWideLinesUseParallelogram)"]
    pub non_strict_wide_lines_use_parallelogram: Option<bool>,
    #[doc = "- [Vulkan documentation](https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkPhysicalDeviceExternalFormatResolvePropertiesANDROID.html#limits-nullColorAttachmentWithExternalFormatResolve)"]
    ...
    #[doc = "- [Vulkan documentation](https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkPhysicalDeviceHostImageCopyPropertiesEXT.html#limits-optimalTilingLayoutUUID)"]
    pub optimal_tiling_layout_uuid: Option<[u8; 16]>,
    #[doc = "- [Vulkan documentation](https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkPhysicalDeviceHostImageCopyPropertiesEXT.html#limits-pCopyDstLayouts)"]
    pub copy_dst_layouts: Option<Vec<ImageLayout>>,
    #[doc = "- [Vulkan documentation](https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkPhysicalDeviceHostImageCopyPropertiesEXT.html#limits-pCopySrcLayouts)"]
    ...
    #[doc = "- [Vulkan documentation](https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkPhysicalDeviceShaderCorePropertiesARM.html#limits-pixelRate)"]
    ...
    #[doc = "- [Vulkan documentation](https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkPhysicalDeviceMaintenance5PropertiesKHR.html#limits-polygonModePointSize)"]
    ...
    #[doc = "- [Vulkan documentation](https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkPhysicalDeviceRenderPassStripedPropertiesARM.html#limits-renderPassStripeGranularity)"]
    ...
    #[doc = "- [Vulkan documentation](https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkPhysicalDeviceSchedulingControlsPropertiesARM.html#limits-schedulingControlsFlags)"]
    ...
    #[doc = "- [Vulkan documentation](https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkPhysicalDeviceShaderObjectPropertiesEXT.html#limits-shaderBinaryUUID)"]
    pub shader_binary_uuid: Option<[u8; 16]>,
    #[doc = "- [Vulkan documentation](https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkPhysicalDeviceShaderObjectPropertiesEXT.html#limits-shaderBinaryVersion)"]
    ...
    #[doc = "- [Vulkan documentation](https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkPhysicalDeviceShaderTileImagePropertiesEXT.html#limits-shaderTileImageCoherentReadAccelerated)"]
    pub shader_tile_image_coherent_read_accelerated: Option<bool>,
    #[doc = "- [Vulkan documentation](https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkPhysicalDeviceShaderTileImagePropertiesEXT.html#limits-shaderTileImageReadFromHelperInvocation)"]
    pub shader_tile_image_read_from_helper_invocation: Option<bool>,
    #[doc = "- [Vulkan documentation](https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkPhysicalDeviceShaderTileImagePropertiesEXT.html#limits-shaderTileImageReadSampleFromPixelRateInvocation)"]
    ...
    #[doc = "- [Vulkan documentation](https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkPhysicalDeviceVertexAttributeDivisorPropertiesKHR.html#limits-supportsNonZeroFirstInstance)"]
    pub supports_non_zero_first_instance: Option<bool>,
    #[doc = "- [Vulkan documentation](https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkPhysicalDeviceShaderCorePropertiesARM.html#limits-texelRate)"]
    ...
    #[doc = "- [Vulkan documentation](https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkPhysicalDeviceLayeredDriverPropertiesMSFT.html#limits-underlyingAPI)"]
...
impl DevicePropertiesFfi {
    pub(crate) fn make_chain(
        ...
        if [device_extensions.khr_cooperative_matrix]
            ...
            && [].into_iter().all(|x| x)
        {
            self.properties_cooperative_matrix_khr = Some(Default::default());
            let member = self.properties_cooperative_matrix_khr.as_mut().unwrap();
            member.p_next = head.p_next;
            head.p_next = <*mut _>::cast(member);
        }
        ...
        .any(|x| x)
            && [].into_iter().all(|x| x)
        {
            self.properties_line_rasterization_khr = Some(Default::default());
            let member = self.properties_line_rasterization_khr.as_mut().unwrap();
            member.p_next = head.p_next;
            head.p_next = <*mut _>::cast(member);
        }
        if [device_extensions.khr_maintenance5].into_iter().any(|x| x) && [].into_iter().all(|x| x)
        {
            self.properties_maintenance5_khr = Some(Default::default());
            let member = self.properties_maintenance5_khr.as_mut().unwrap();
            member.p_next = head.p_next;
            head.p_next = <*mut _>::cast(member);
        }
        if [device_extensions.khr_maintenance6].into_iter().any(|x| x) && [].into_iter().all(|x| x)
        {
            self.properties_maintenance6_khr = Some(Default::default());
            let member = self.properties_maintenance6_khr.as_mut().unwrap();
            member.p_next = head.p_next;
            head.p_next = <*mut _>::cast(member);
        }
        ...
        if [device_extensions.khr_vertex_attribute_divisor]
            ...
            && [].into_iter().all(|x| x)
        {
            self.properties_vertex_attribute_divisor_khr = Some(Default::default());
            let member = self
                .properties_vertex_attribute_divisor_khr
                .as_mut()
                .unwrap();
        ...
        if [device_extensions.ext_host_image_copy]
            ...
            && [].into_iter().all(|x| x)
        {
            self.properties_host_image_copy_ext = Some(Default::default());
            let member = self.properties_host_image_copy_ext.as_mut().unwrap();
            member.p_next = head.p_next;
            head.p_next = <*mut _>::cast(member);
        }
        if [device_extensions.ext_map_memory_placed]
            ...
            && [].into_iter().all(|x| x)
        {
            self.properties_map_memory_placed_ext = Some(Default::default());
            let member = self.properties_map_memory_placed_ext.as_mut().unwrap();
            member.p_next = head.p_next;
            head.p_next = <*mut _>::cast(member);
        }
        ...
        if [device_extensions.ext_nested_command_buffer]
            ...
            && [].into_iter().all(|x| x)
        {
            self.properties_nested_command_buffer_ext = Some(Default::default());
            let member = self.properties_nested_command_buffer_ext.as_mut().unwrap();
            member.p_next = head.p_next;
            head.p_next = <*mut _>::cast(member);
        }
        ...
        if [device_extensions.ext_shader_object].into_iter().any(|x| x) && [].into_iter().all(|x| x)
        {
            self.properties_shader_object_ext = Some(Default::default());
            let member = self.properties_shader_object_ext.as_mut().unwrap();
            member.p_next = head.p_next;
            head.p_next = <*mut _>::cast(member);
        }
        if [device_extensions.ext_shader_tile_image]
            ...
            && [].into_iter().all(|x| x)
        {
            self.properties_shader_tile_image_ext = Some(Default::default());
            let member = self.properties_shader_tile_image_ext.as_mut().unwrap();
            member.p_next = head.p_next;
            head.p_next = <*mut _>::cast(member);
        }
        ...
        if [device_extensions.ext_vertex_attribute_divisor]
            .into_iter()
            .any(|x| x)
            && [self.properties_vertex_attribute_divisor_khr.is_none()]
                .into_iter()
                .all(|x| x)
        {
        ...
        if [device_extensions.huawei_cluster_culling_shader]
            ...
            && [].into_iter().all(|x| x)
        {
            self.properties_cluster_culling_shader_huawei = Some(Default::default());
            let member = self
                .properties_cluster_culling_shader_huawei
                .as_mut()
                .unwrap();
        ...
        if [device_extensions.nv_cooperative_matrix]
            .into_iter()
            .any(|x| x)
            && [self.properties_cooperative_matrix_khr.is_none()]
                .into_iter()
                .all(|x| x)
        {
        ...
        if [device_extensions.nv_cuda_kernel_launch]
            ...
            && [].into_iter().all(|x| x)
        {
            self.properties_cuda_kernel_launch_nv = Some(Default::default());
            let member = self.properties_cuda_kernel_launch_nv.as_mut().unwrap();
            member.p_next = head.p_next;
            head.p_next = <*mut _>::cast(member);
        }
        ...
        if [device_extensions.nv_displacement_micromap]
            ...
            && [].into_iter().all(|x| x)
        {
            self.properties_displacement_micromap_nv = Some(Default::default());
            let member = self.properties_displacement_micromap_nv.as_mut().unwrap();
            member.p_next = head.p_next;
            head.p_next = <*mut _>::cast(member);
        }
        if [device_extensions.nv_extended_sparse_address_space]
            ...
            && [].into_iter().all(|x| x)
        {
            self.properties_extended_sparse_address_space_nv = Some(Default::default());
            let member = self
                .properties_extended_sparse_address_space_nv
                .as_mut()
                .unwrap();
        ...
        if [device_extensions.android_external_format_resolve]
            ...
            && [].into_iter().all(|x| x)
        {
            self.properties_external_format_resolve_android = Some(Default::default());
            let member = self
                .properties_external_format_resolve_android
                .as_mut()
                .unwrap();
        ...
        if [device_extensions.qcom_image_processing2]
            ...
            && [].into_iter().all(|x| x)
        {
            self.properties_image_processing2_qcom = Some(Default::default());
            let member = self.properties_image_processing2_qcom.as_mut().unwrap();
            member.p_next = head.p_next;
            head.p_next = <*mut _>::cast(member);
        }
        ...
        if [device_extensions.msft_layered_driver]
            .into_iter()
            .any(|x| x)
            && [].into_iter().all(|x| x)
        {
            self.properties_layered_driver_msft = Some(Default::default());
            let member = self.properties_layered_driver_msft.as_mut().unwrap();
            member.p_next = head.p_next;
            head.p_next = <*mut _>::cast(member);
        }
        ...
        if [device_extensions.arm_render_pass_striped]
            ...
            && [].into_iter().all(|x| x)
        {
            self.properties_render_pass_striped_arm = Some(Default::default());
            let member = self.properties_render_pass_striped_arm.as_mut().unwrap();
            member.p_next = head.p_next;
            head.p_next = <*mut _>::cast(member);
        }
        if [device_extensions.arm_scheduling_controls]
            ...
            && [].into_iter().all(|x| x)
        {
            self.properties_scheduling_controls_arm = Some(Default::default());
            let member = self.properties_scheduling_controls_arm.as_mut().unwrap();
            member.p_next = head.p_next;
            head.p_next = <*mut _>::cast(member);
        }
        ...
        if [device_extensions.arm_shader_core_properties]
            .into_iter()
            .any(|x| x)
            && [].into_iter().all(|x| x)
        {
            self.properties_shader_core_arm = Some(Default::default());
            let member = self.properties_shader_core_arm.as_mut().unwrap();
            member.p_next = head.p_next;
            head.p_next = <*mut _>::cast(member);
        }
        if [device_extensions.amdx_shader_enqueue]
            ...
            && [].into_iter().all(|x| x)
        {
            self.properties_shader_enqueue_amdx = Some(Default::default());
            let member = self.properties_shader_enqueue_amdx.as_mut().unwrap();
            member.p_next = head.p_next;
            head.p_next = <*mut _>::cast(member);
        }
